...
- **Where to look** (1 connections) — `.claude/skills/windows-control/SKILL.md`
- **Working style** (1 connections) — `.claude/skills/windows-control/SKILL.md`
...
- `.claude/skills/windows-control/SKILL.md`
